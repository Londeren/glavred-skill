...
**Основан на** книге Максима Ильяхова и Людмилы Сарычевой «Пиши, сокращай 2025», книге Максима Ильяхова «Ясно, понятно», книге Максима Ильяхова и Родиона Скрябина «Большая книга о соцсетях для предпринимателей, экспертов» (из неё — 47 из 184 правил скилла, весь блок про формат поста) и рассылке «Сильный текст». Полные тексты источников в репозиторий не входят. Провенанс извлечения — карта источников, улов, валидация, эвалы — ведётся в рабочей сборке и в публичный репозиторий не включён из-за объёма дословных цитат из книг; статистика конвейера и ограничения проверок — в [docs/PROVENANCE.md](docs/PROVENANCE.md). Лицензия — [MIT](LICENSE).
